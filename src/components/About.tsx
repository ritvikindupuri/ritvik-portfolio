                ...
                <div className="grid md:grid-cols-3 gap-8">
                  {[
                    ...
                    return (
                      ...
                      >
                        <div className={`absolute inset-0 bg-gradient-to-br ${interest.gradient} rounded-xl opacity-0 group-hover/card:opacity-100 transition-opacity duration-500 blur-xl`} />
